            ...
            <div class="col-12">
                ...
                <div class="mb-100 clearfix">
                    <div class="login_form">
                        ...
                        <form action="{{ route('postActivate') }}" method="post">
                            @csrf
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="radio" id="male" class="" {{ old('genger') === 'male' ? 'checked' : '' }} name="gender">
                                                <label for="female" {{ old('genger') === 'female' ? 'checked' : '' }}>Female</label>
