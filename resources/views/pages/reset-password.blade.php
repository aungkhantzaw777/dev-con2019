                    ...
                    <form method="POST" action="{{ route('post-reset') }}">
                            ...
                            <div class="input_area">
                                <div class="row bg-img bg-gradient-overlay">
                                    <!-- Form Group -->
                                    <input type="hidden" name="auth" value="{{ $user->password_code }}" >
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="password" class="form-control mb-30" name="password_confirmation" id="password_comfirm" placeholder="Comfirm Password" required>
                                        </div>
                                    </div>
